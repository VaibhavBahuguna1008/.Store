...
export const getAllOrdersController = async (req, res) => {
  try {
    // Fetch orders, populating buyer and products, and sorting by creation date
    const orders = await orderModel
      .find({})
      .populate("products", "-photo") // Exclude product photo for optimization
      .populate("buyer", "name")      // Populate only buyer's name
    ...
    res.status(500).send({
      ...
      error: error.message, // Send the specific error message back
    });
  }
};
